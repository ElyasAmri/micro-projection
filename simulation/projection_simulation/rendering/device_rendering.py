...
from .device_dimensions import (
    PROJECTOR_HOLDER_HEIGHT_CM,
    PROJECTOR_HOLDER_INNER_DROP_CM,
    PROJECTOR_HOLDER_INNER_SIZE_CM,
    PROJECTOR_HOLDER_OUTER_HEIGHT_CM,
    PROJECTOR_HOLDER_OUTER_SIZE_CM,
    SURFACE_CLAMP_BOTTOM_RECT_HEIGHT_CM,
    SURFACE_CLAMP_CIRCLE_CENTER_HEIGHT_CM,
    SURFACE_CLAMP_INNER_CIRCLE_DIAMETER_CM,
    SURFACE_CLAMP_OUTER_CIRCLE_DIAMETER_CM,
    SURFACE_CLAMP_THICKNESS_CM,
    SURFACE_CLAMP_TOTAL_HEIGHT_CM,
)
